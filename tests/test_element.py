...
def test_element_foundamental_methods():
    """Test the Element class foundamental methods _build_css_selector and retrieve."""
    element = Element(
        tag="button",
        id="my-button",
    ...
    with patch("elements.element.WebDriverWait") as WebDriverWaitMock:
        wait_instance = WebDriverWaitMock.return_value
...
def test_element_generic_methods():
    """Test the Element class generic methods."""
    element = Element(
        tag="button",
        id="my-button",
        name="my-magic-button",
